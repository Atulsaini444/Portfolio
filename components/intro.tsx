    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          <motion.span
            className="absolute bottom-0 right-0 left-16 text-4xl"
      ...
      >
        ...
        <span className="font-bold">web🌐.</span> I'm a frontend fanatic, always striving for the perfect user experience with almost 3 years of experience.
      </motion.h1>
